...
for i in range(3):
    for j in range(3):
        if i == 0:  
            design.CSHAPE(0.6 + (j * 0.1), fill_factor = 0.75, waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * 2 * i, rot=180, wg_length=150)
            design.text("P:" + str(0.6 + (j * 0.1)) + "F:0.75", size=25, position=(j * 270 - 50, 50))
        if i == 1:
            design.CSHAPE(period = 0.9 + (j * 0.1), fill_factor = 0.75, waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * 2 * i, rot=180, wg_length=150)
            design.text("P:" + str(0.9 + (j * 0.1)) + "F:0.75", size=25, position=(j * 270 - 50, 50 - 100 * 2))
        if i == 2:
            design.CSHAPE(period = 1.2 + (j * 0.1), fill_factor = 0.75, waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * 2 * i, rot=180, wg_length=150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 1.108, fill_factor = 0.4 + (j * 0.05), waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * 2 * i - 100 * 6, rot=180, wg_length=150)
            design.text("P:1.1F:" + str(0.4 + (j * 0.05)), size=25, position=(j * 270 - 50, 50 - 100 * 6))
        if i == 1:
            design.CSHAPE(period = 1.108, fill_factor = 0.55 + (j * 0.05), waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * 2 * i - 100 * 6, rot=180, wg_length=150)
            design.text("P:1.1F:" + "{:.2f}".format(0.55 + (j * 0.05)), size=25, position=(j * 270 - 50, 50 - 100 * 8))
        if i == 2:
            design.CSHAPE(period = 1.108, fill_factor = 0.7 + (j * 0.05), waveguide_width= 1, pos_x=-j * 270, pos_y=-100 * i * 2 - 100 * 6, rot=180, wg_length=150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 1, fill_factor = 0.4 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i, rot=180, wg_length = 150)
            design.text("P:1.0F:" + str(0.4 + (j * 0.05)), size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 0))
        if i == 1:
            design.CSHAPE(period = 1, fill_factor = 0.55 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i , rot=180, wg_length = 150)
            design.text("P:1.0F:" + "{:.2f}".format(0.55 + (j * 0.05)), size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 2))

        if i == 2:
            design.CSHAPE(period = 1, fill_factor = 0.7 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * i * 2, rot=180, wg_length = 150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 1.2, fill_factor = 0.4 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i - 600, rot=180, wg_length = 150)
            design.text("P:1.2F:" + str(0.4 + (j * 0.05)), size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 6))
        if i == 1:
            design.CSHAPE(period = 1.2, fill_factor = 0.55 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i - 600, rot=180, wg_length = 150)
            design.text("P:1.2F:" + "{:.2f}".format(0.55 + (j * 0.05)), size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 8))

        if i == 2:
            design.CSHAPE(period = 1.2, fill_factor = 0.7 + (j * 0.05), waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * i * 2 - 600, rot=180, wg_length = 150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 1 + (j * 0.025), fill_factor = 0.75, waveguide_width = 1, pos_x = -j * 270, pos_y = -100 * 2 * i - 1200, rot=180, wg_length = 150)
            design.text(f"P:{1 + (j * 0.025):.2f}F:0.75", size=25, position=(j * 270 - 50, 50 - 100 * 12))
        if i == 1:
            design.CSHAPE(period = 1.05 + (j * 0.025), fill_factor = 0.75, waveguide_width = 1, pos_x = -j * 270, pos_y = -100 * 2 * i - 1200, rot=180, wg_length = 150)
            design.text(f"P:{1.05 + (j * 0.025):.2f}F:0.75", size=25, position=(j * 270 - 50, 50 - 100 * 14))
        if i == 2:
            design.CSHAPE(period = 1.1 + (j * 0.025), fill_factor = 0.75, waveguide_width = 1, pos_x = -j * 270, pos_y = -100 * 2 * i - 1200, rot=180, wg_length = 150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 0.6 + (j * 0.1), fill_factor = 0.4, waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i - 1200, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.6 + (j * 0.1)) + "F:0.4", size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 12))
        if i == 1:
            design.CSHAPE(period = 0.9 + (j * 0.1), fill_factor = 0.4, waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i -1200, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.9 + (j * 0.1)) + "F:0.4", size=25, position=(j * 270 - 50 + 270 * 3, 50 -100*14))
        if i == 2:
            design.CSHAPE(period = 1.2 + (j * 0.1), fill_factor = 0.4, waveguide_width = 1, pos_x = -j * 270 -3 *270 , pos_y = -100 * i *2 -1200, rot=180, wg_length =150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 0.6 + (j * 0.1), fill_factor = 0.8, waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i - 1800, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.6 + (j * 0.1)) + "F:0.8", size=25, position=(j * 270 - 50 + 270 * 3, 50 - 100 * 18))
        if i == 1:
            design.CSHAPE(period = 0.9 + (j * 0.1), fill_factor = 0.8, waveguide_width = 1, pos_x = -j * 270 - 3 * 270, pos_y = -100 * 2 * i -1800, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.9 + (j * 0.1)) + "F:0.8", size=25, position=(j * 270 - 50 + 270 * 3, 50 -100*20))
        if i == 2:
            design.CSHAPE(period = 1.2 + (j * 0.1), fill_factor = 0.8, waveguide_width = 1, pos_x = -j * 270 -3 *270 , pos_y = -100 * i *2 -1800, rot=180, wg_length =150)
...
for i in range(3):
    for j in range(3):
        if i == 0:
            design.CSHAPE(period = 0.6 + (j * 0.1), fill_factor = 0.6, waveguide_width = 1, pos_x = -j * 270 - 0 * 270, pos_y = -100 * 2 * i - 1800, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.6 + (j * 0.1)) + "F:0.6", size=25, position=(j * 270 - 50 + 270 * 0, 50 - 100 * 18))
        if i == 1:
            design.CSHAPE(period = 0.9 + (j * 0.1), fill_factor = 0.6, waveguide_width = 1, pos_x = -j * 270 - 0 * 270, pos_y = -100 * 2 * i -1800, rot=180, wg_length = 150)
            design.text("P:" + "{:.2f}".format(0.9 + (j * 0.1)) + "F:0.6", size=25, position=(j * 270 - 50 + 270 * 0, 50 -100*20))
        if i == 2:
            design.CSHAPE(period = 1.2 + (j * 0.1), fill_factor = 0.6, waveguide_width = 1, pos_x = -j * 270 -0 *270 , pos_y = -100 * i *2 -1800, rot=180, wg_length =150)
            design.text("P:" + "{:.2f}".format(1.2 + (j * 0.1)) + "F:0.6", size=25, position=(j * 270 -50 +270*0 ,50-100*22))


design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8, pos_y = -16.9 - 80.508 + 40.2, lengthx=100)
design.text("100", size=25, position = (230 * 6.85, 50))

design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8 -50, pos_y = -16.9 - 80.508+40.2 + 127 * 2 -65, lengthx=150)
design.text("150", size=25, position = (230 * 6.85, 50 - 137 * 1.5))

design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8 -100, pos_y = -16.9 - 80.508+40.2 + 127 * 4 +60 - 185, lengthx=200)
design.text("200", size=25, position = (230 * 6.85, 50 - 137 * 3))

design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8 -150, pos_y = -16.9 - 80.508+40.2 + 127 * 6 +60 - 235, lengthx=250)
design.text("250", size=25, position = (230 * 6.85, 50 - 137 * 4))

design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8 -200, pos_y = -16.9 - 80.508+40.2 + 127 * 8 +60 - 295, lengthx=300)
design.text("300", size=25, position = (230 * 6.85, 50 - 137 * 5.5))

design.spiral(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 8 -250, pos_y = -16.9 - 80.508+40.2 + 127 * 10 +60 - 335, lengthx=350)
design.text("350", size=25, position = (230 * 6.85, 50 - 137 * 7))

design.s(period=1.108, fill_factor=0.75, number_of_loops = 10, pos_x = -230 * 10 -250, pos_y = -16.9 - 80.508 + 40.2, lengthx=400)
